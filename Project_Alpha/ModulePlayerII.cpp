		 ...
		 if (currentstateP2 == idlestateP2) {
			 ...
			 if (!App->player->closeP1) {
				 if (inputplayerP2.Num7_active) {
					 ...
					 App->audio->PlayFx(L_attack_sound_P2);
					 LOG("IDLE to LP");
				 ...
				 if (inputplayerP2.Num8_active) {
					 ...
					 App->audio->PlayFx(M_attack_sound_P2);
				 ...
				 if (inputplayerP2.Num9_active) {
					 ...
					 App->audio->PlayFx(H_attack_sound_P2);
					 LOG("IDLE to HEAVY PUNCH");
				 }
				...
				if (currentstateP2 != crouchstateP2 && currentstateP2 != crouchLPP2 && currentstateP2 != crouchMPP2 && currentstateP2 != crouchHPP2 && currentstateP2 != crouchLKP2 && currentstateP2 != crouchMKP2 && currentstateP2 != crouchHKP2) {
					...
					if (c2->attack == SL) { //L
						if (!SblockingP2) {
							...
							alreadyHitP2 = true;
							deleteCollider2(attackP2_collider);
							App->audio->PlayFx(L_hit_sound_P2);
							App->ui->health2.w -= 5;
						}
						else {
						...
						if (!SblockingP2) {
							...
							alreadyHitP2 = true;
							App->audio->PlayFx(M_hit_sound_P2);
							deleteCollider2(attackP2_collider);
							App->ui->health2.w -= 10;
						}
						else {
						...
						if (!SblockingP2) {
							...
							alreadyHitP2 = true;
							deleteCollider2(attackP2_collider);
							App->audio->PlayFx(H_hit_sound_P2);
							App->ui->health2.w -= 15;
						}
						else {
