...
ModulePlayer2::ModulePlayer2()
{
	...
	idle2.PushBack({ 1152, 14, 154, 96},1.0f);
	idle2.PushBack({ 990, 14, 154, 96 },1.0f);
	idle2.PushBack({ 836, 14, 154, 96 },1.0f);
	idle2.PushBack({ 681 , 14, 154, 96 },1.0f);

	//Walk FORWARD Animation 
	forward2.PushBack({ 1152, 206, 154, 96 },0.5f);
	forward2.PushBack({ 990, 206, 154, 96 },0.5f);
	forward2.PushBack({ 836, 206, 154, 96 },0.5f);
	forward2.PushBack({ 681, 206, 154, 96 },0.5f);
	forward2.PushBack({ 528, 206, 154, 96 },0.5f);
	forward2.PushBack({ 371, 206, 154, 96 },0.5f);

	forward2.loop = true;

	//Walk backwards animation
	backward2.PushBack({ 1152, 110, 154, 96 },0.5f);
	backward2.PushBack({ 990, 110, 154, 96 },0.5f);
	backward2.PushBack({ 836, 110, 154, 96 },0.5f);
	backward2.PushBack({ 681, 110, 154, 96 },0.5f);
	backward2.PushBack({ 528, 110, 154, 96 },0.5f);
	backward2.PushBack({ 371, 110, 154, 96 },0.5f);
	backward2.loop = true;

	//Crouch Animation
	crouch2.PushBack({ 371, 14, 154, 96 },0.5f);
	crouch2.PushBack({ 210, 14, 154, 96 },0.5f);
	crouch2.PushBack({ 57, 14, 154, 96 },0.5f);
	crouch2.speed = 0.5;
	crouch2.loop = false;

	//Ryu jump
	jump2.PushBack({ 1151, 514, 154, 111 },0.5f);
	jump2.PushBack({ 989, 514, 154, 111 },0.5f);
	jump2.PushBack({ 835, 514, 154, 111 },0.5f);
	jump2.PushBack({ 681, 504, 154, 111 },0.5f);
	jump2.PushBack({ 527, 504, 154, 111 },0.5f);
	jump2.PushBack({ 371, 514, 154, 111 },0.5f);
	jump2.loop = false;
	
	//Forward Jump Animation
	forwardjump2.PushBack({ 1151, 625, 154, 111 },0.5f);
	forwardjump2.PushBack({ 989, 625, 154, 111 },0.5f);
	forwardjump2.PushBack({ 371, 625, 154, 111 },0.5f);
	forwardjump2.PushBack({ 527, 625, 154, 111 },0.5f);
	forwardjump2.PushBack({ 836, 625, 154, 111 },0.5f);
	forwardjump2.PushBack({ 681, 625, 154, 111 },0.5f);
	forwardjump2.PushBack({ 371, 514, 154, 111 },0.5f);
	forwardjump2.loop = false;

	//Backward Jump Animation
	backwardjump2.PushBack({ 681, 625, 154, 111 },0.5f);
	backwardjump2.PushBack({ 836, 625, 154, 111 },0.5f);
	backwardjump2.PushBack({ 527, 625, 154, 111 },0.5f);
	backwardjump2.PushBack({ 371, 625, 154, 111 },0.5f);
	backwardjump2.PushBack({ 989, 625, 154, 111 },0.5f);
	backwardjump2.PushBack({ 1151, 625, 154, 111 },0.5f);
	backwardjump2.loop = false;

	//Ryu Hadouken movement
	hadouken2.PushBack({ 1151, 740, 154, 95 },0.5f);
	hadouken2.PushBack({ 989, 740, 154, 95 },0.5f);
	hadouken2.PushBack({ 836, 740, 154, 95 },0.5f);
	hadouken2.PushBack({ 681, 740, 154, 95 },0.5f);
	hadouken2.loop = false;
	 
	//Damaged Animation
	
	//Ryu light punch
	lightPunch2.PushBack({ 1151, 1171, 154, 96 },0.5f);
	lightPunch2.PushBack({ 989, 1171, 154, 96 },0.5f);
	lightPunch2.PushBack({ 1151, 1171, 154, 96 },0.5f);
	lightPunch2.loop = false;

	//Ryu light kick
	lightKick2.PushBack({ 1151, 1274, 154, 97 },0.5f);
	lightKick2.PushBack({ 989, 1274, 154, 98 },0.5f);
	lightKick2.loop = false;
	
	//punchcrouch Animation
	crouchpunch2.PushBack({ 1151, 1663, 164, 81 },0.5f);
	crouchpunch2.PushBack({ 989, 1663, 164, 81 },0.5f);
	crouchpunch2.loop = false;

	//kickcrouch Animation  
	crouchkick2.PushBack({ 1151, 1912, 164, 71 },0.5f);
	crouchkick2.PushBack({ 989, 1912, 164, 71 },0.5f);
	crouchkick2.loop = false;

	//Neutral punch jump Animation
	jumppunch2.PushBack({ 1151, 1375, 162, 86 },0.5f);
	jumppunch2.PushBack({ 989, 1375, 162, 86 },0.5f);
	jumppunch2.loop = false;
	
	//Neutral kick jump Animation
	jumpkick2.PushBack({ 1151, 1456, 162, 121 },0.5f);
	jumpkick2.loop = false;

	//Jumpbackkick Animation
	jumpbackkick2.PushBack({ 681, 1578, 164, 91 },0.5f);
	jumpbackkick2.PushBack({ 528, 1578, 164, 91 },0.5f);
	jumpbackkick2.loop = false;

	//jumpbackpunch Animation
	jumpbackpunch2.PushBack({ 1151, 1375, 162, 86 },0.5f);
	jumpbackpunch2.PushBack({ 989, 1375, 162, 86 },0.5f);
	jumpbackpunch2.loop = false;
	
	//jumpfrontkick Animation
	jumpfrontkick2.PushBack({ 681,1578, 164, 91 },0.5f);
	jumpfrontkick2.PushBack({ 528,1578, 164, 91 },0.5f);
	jumpfrontkick2.loop = false;
	
	//jumpfrontpunch Animation 

	jumpfrontpunch2.PushBack({ 1151, 1375, 162, 86 },0.5f);
	jumpfrontpunch2.PushBack({ 989, 1375, 162, 86 },0.5f);
